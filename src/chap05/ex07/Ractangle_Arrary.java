...
public class Ractangle_Arrary {
	...
	public static void main(String[] args) {
		...
		// 3. 배열 변수 선언시 값을 바로 할당 : 방 크기 지정하면 오류 발생(주의)
...
//		System.out.println(Arrays.toString(arr6[3])); //ArrayIndexOutOfBoundsException
		
		//4. 배열변수 선언시 값을 바로 할당 ( new int[][] 생략 사용 )
			// 주의 : 선언과 값을 분리할 수 없다. 오류 발생
		int [][] arr7 = {{1,2,3},{11,22,33},{111,222,333}};
		
//		int [][] arr8;
//		arr8 = {{1,2,3},{11,22,33},{111,222,333}}; 오류발생 ==> arr8 = new int [][] {{1,2,3},{11,22,33},{111,222,333}};
