...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		//2. 증감 연산자 : ++, --
		int val1 = 3;
		System.out.println(++val1); //4 값을 먼저 더하고 출력
		...
		int val2 = 3;
		System.out.println(val2++); //3 값을 출력하고 더함
		...
		System.out.println("val9의 값: " + val9); //10
		System.out.println("val7의 값: " + val7); //2
		System.out.println("val8의 값: " + val8); //5
